...
var toolNames = map[string]string{
	...
	"POST /api/dags/{id}/backfill":                "backfill_dag",
	"POST /api/events":                            "publish_event",
	"GET /api/dags/{id}/task-durations":           "get_task_durations",
	"GET /api/dags/{id}/versions":                 "list_dag_versions",
